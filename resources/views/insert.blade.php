...
<body>
    <h1 class="text-center mb-4">Insert Data Teams</h1>
                    ...
                    <div class="card-body">
                        <form action="/insertdata" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="mb-3">
                              ...
                              <input type="text" name="position_id" class="form-control" id="exampleInputEmail1">
                            </div>
                            <div class="mb-3">
                              <label for="exampleInputEmail1" class="form-label">Photo Team:</label>
                              <input type="file" name="photo_team" class="form-control">
                            </div>
                            <div class="mb-3">
                              <label for="exampleInputEmail1" class="form-label">Moto:</label>
                              <input type="text" name="moto" class="form-control" id="exampleInputEmail1">
                            </div>
                            <div class="mb-3">
